  ...
  return (
    <div className="flex flex-col justify-center gap-5">
      ...
      <div className="flex justify-center sm:justify-start items-center gap-2">
        <div
          className={`flex items-center gap-2 cursor-pointer bg-gradient-to-r from-indigo-600 to-cyan-600 text-white px-5 py-2.5 rounded-md`}
          //onClick={loginGoogle}
        >
        ...
        <div
          className={`flex items-center gap-2 cursor-pointer text-zinc-300 px-5 py-2.5`}
        >
          <IconVideo stroke={1} />
          <span className="font-thin md:text-sm text-base">
